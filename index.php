  ...
  <body>
    <div class="parent">
      <div class="borderUnderChild">
        ...
        <div class="tabelSubChild" ng-app="myApp" ng-controller="personenCtrl">
      ...
      <div class="routing" ng-app="routingApp" ng-controller="routingCtrl">
